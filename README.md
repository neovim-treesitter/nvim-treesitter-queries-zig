...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-zig/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-zig/actions/workflows/validate.yml)

Neovim tree-sitter queries for **zig**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-zig",
...
- [ ] Changes are scoped to `zig` — do not include files for other languages
